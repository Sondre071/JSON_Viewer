<template>
                ...
                <tr>
                    <th v-for="field, index in dynamicFields.jsonKeys">
                        ...
                        <button :key="field" class="row-header-button icon" @click="sortTable(field)"
                            ...
                            <div v-show="booleans.filterMode">
    ...
    <div class="side-panel">
        <button @click="booleans.filterMode ? booleans.filterMode = false : booleans.filterMode = true" ><i class="bi bi-funnel side-panel-button"></i></button>
    </div>
...
const testVar = JSON.stringify(Object.values(dataset("override")[0]))
const getSearch = () => {
